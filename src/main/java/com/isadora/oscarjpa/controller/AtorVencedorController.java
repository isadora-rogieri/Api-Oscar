...
public class AtorVencedorController {
    ...
    @PostMapping
    public ResponseEntity salvarAtorVencedor(@Valid @RequestBody AtorVencedor atorVencedor){
    ...
    @PutMapping("/{id}")
    public String alterarAtorVencedor(@Valid @PathVariable("id") Long id, @RequestBody AtorVencedor atorVencedor){
